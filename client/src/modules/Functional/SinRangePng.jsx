...
export default function SinRangePng() {
    ...
    const wcFunction = 'sin-range-png';
    ...
    const fetchData = async () => {
        ...
        if (a && b) {
            try {
                ...
                console.log('>>>-sin-range-png-fetchData-error->', error);
                setIsError(true);
            }
        } else {
            setIsError(false);
    ...
    return (
        <Card>
            <Card.Header>Sinus By Range</Card.Header>
            <Card.Body>
                <Card.Title>Sinus Function By [A; B]</Card.Title>
                <Card.Text>
