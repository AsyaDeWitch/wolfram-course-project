...
export default function TgRangePng() {
    ...
    const fetchData = async () => {
        ...
        if (a && b) {
            try {
                ...
                console.log('>>>-tg-range-png-fetchData-error->', error);
                setIsError(true);
            }
        } else {
            setIsError(false);
    ...
    return (
        <Card>
            <Card.Header>Tg By Range</Card.Header>
            <Card.Body>
                <Card.Title>Tg Function By [A; B]</Card.Title>
                <Card.Text>
