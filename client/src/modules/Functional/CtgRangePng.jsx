...
export default function CtgRangePng() {
    ...
    const wcFunction = 'ctg-range-png';
    ...
    const fetchData = async () => {
        ...
        if (a && b) {
            try {
                ...
                console.log('>>>-ctg-range-png-fetchData-error->', error);
                setIsError(true);
            }
        } else {
            setIsError(false);
    ...
    return (
        <Card>
            <Card.Header>Ctg By Range</Card.Header>
            <Card.Body>
                <Card.Title>Ctg Function By [A; B]</Card.Title>
                <Card.Text>
